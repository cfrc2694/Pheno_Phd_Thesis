...
\begin{frame}{The Standard Model of Particle Physics}
    ...
    \begin{minipage}[t]{0.53\linewidth}
        ...
        \includegraphics[width=1.05\linewidth]{../Images/RDRDst_hflav.pdf}    
...
\begin{frame}{Large Hadron Collider}
	\begin{minipage}{.55\linewidth}
		{\centering
		\includegraphics[width=.9\linewidth]{../Images/pp_collision.png}
...
\begin{frame}{BSM Signatures on the Di-Tau Channel at the LHC}{LFV and $\tau$ lepton as window to new physics}
	...
	\begin{minipage}{.45\linewidth}
		\begin{center}
			\includegraphics[width=.9\linewidth]{../Images/DY.pdf}
		\end{center}
	\end{minipage}
	\hfill
	\begin{minipage}{.45\linewidth}
		\begin{center}
			\includegraphics[width=.9\linewidth]{../Images/DY_scalar.pdf}
		\end{center}
	\end{minipage}
	...
	\begin{minipage}{.45\linewidth}
		\begin{center}
			\includegraphics[width=.9\linewidth]{../Images/non-res_vector.pdf}
		\end{center}
	\end{minipage}
	\hfill
	\begin{minipage}{.45\linewidth}
		\begin{center}
			\includegraphics[width=.9\linewidth]{../Images/non-res_scalar.pdf}
		\end{center}
	\end{minipage}
  \begin{center}
		{ \large
...
\begin{frame}{Interference Phenomena in the SM}{Photon and $Z$-boson interference, $q \bar q \longrightarrow \tau^+ \tau^- $}
    ...
    \begin{minipage}{0.33\textwidth}
        \begin{center}
            \includegraphics[width=.8\linewidth]{../Images/DY.png}
        \end{center}
    \end{minipage}
    \pause
    $ $\\$ $\\$ $
...
\begin{frame}{Example: The Vector Leptoquark Model}
		\begin{center}
			\includegraphics[width=1.03\linewidth]{../Images/on_vLQ.png}
		\end{center}	
