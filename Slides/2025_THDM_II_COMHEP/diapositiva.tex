...
\begin{frame}{ $m_{H^\pm} \gtrsim 750$ GeV + HB constraints (Work in progress)}
    ...
    \begin{center}
        \includegraphics[width=1\linewidth]{../Images/Allowed_Parameter_Space.png}
    \end{center}
...
\begin{frame}{LHC production cross-section (hadronic channel) (work in progress)}
    \begin{center}
        \includegraphics[width=1\linewidth]{../Images/money_plot_with_significance_thresholds.png}
    \end{center}
...
\begin{frame}{$\tan\beta$ effects on the cross-section (work in progress)}
    \begin{center}
        \includegraphics[width=1\linewidth]{../Images/cross_sections_vs_tanbeta_combined.png}
    \end{center}
...
\begin{frame}{High-Lumi Projections (work in progress)}
    \begin{center}
        \includegraphics[width=1\linewidth]{../Images/xs_heatmap_with_significance_contours.png}
    \end{center}
