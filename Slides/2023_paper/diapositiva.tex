...
\begin{frame}{Lepton Flavor Universality in the SM of Particle Physics}{What is it?}
	\begin{center}
		\includegraphics[width=.75\linewidth]{../Images/SM.png}	
	\end{center}
...
\begin{frame}{A Hint on Lepton Flavor Universality Violation}{$R(D)$ and $R(D^*)$ anomalies}
	\begin{center}
		\includegraphics[width=.75\linewidth]{../Images/RDRDst_hflav.pdf}
	\end{center}
	\begin{equation}
...
\begin{frame}{Leptoquarks and $R(D)$/ $R(D^*)$ anomalies}
	\begin{multicols}{2}
		\includegraphics[width=.99\linewidth]{../Images/B_SM_1.png}
		$$ $$
		\includegraphics[width=.99\linewidth]{../Images/B_SM_2.png}
		\pause
		\includegraphics[width=.99\linewidth]{../Images/B_LQ_1.png}
		$$ $$
		\includegraphics[width=.99\linewidth]{../Images/B_LQ_2.png}
	\end{multicols}
	\pause
	\begin{center}
		{\large $ $\\
...
\begin{frame}{Leptoquark Production at pp Colliders}
	\begin{center}
		\includegraphics[width=.30\textwidth]{../Images/non_resonant.png}\hfill
		\includegraphics[width=.30\textwidth]{../Images/single_LQ.png}\hfill
		\includegraphics[width=.30\textwidth]{../Images/double_LQ.png}
	\end{center}\pause
	\begin{center}
		\includegraphics[width=.45\textwidth]{../Images/XS.png}
		\includegraphics[width=.45\textwidth]{../Images/BR.png}
	\end{center}
\end{frame}
...
\begin{frame}{Interferences between the $Z'$ and the Vector Leptoquark}
	...
	\begin{minipage}{.48\linewidth}
		\begin{center}
			\includegraphics[width=\linewidth]{../Images/Zp.png}
		\end{center}
...
\begin{frame}{Interferences between the $Z'$ and the Vector Leptoquark}
	\begin{center}
		\includegraphics[width=.48\linewidth]{../Images/XS_gu_gzp_lower_limit_woRHC.pdf}
		\includegraphics[width=.48\linewidth]{../Images/XS_gu_gzp_upper_limit_woRHC.pdf}
	\end{center}
	{\large 
...
\begin{frame}{Tau Desintegration Modes}
	\begin{center}
		\includegraphics[width=.99\linewidth]{../Images/tau_decays.png}
		$$ $$\pause
		\includegraphics[width=.99\linewidth]{../Images/tau_decays2.png}
	\end{center}
\end{frame}

\begin{frame}{Kinematic Variables}
	\begin{center}
		\includegraphics[width=.99\linewidth]{../Images/Kinematic_Variables.png}
	\end{center}
\end{frame}
...
\begin{frame}{Boosted Decision Tree}
	\begin{center}
		\includegraphics[width=1.0\linewidth]{../Images/BDT.png}
	\end{center}
\end{frame}
...
\begin{frame}{Cross-Validation}
	\begin{center}
		\includegraphics[width=1.0\linewidth]{../Images/CV.png}
	\end{center}
...
\begin{frame}{Hunting Peaks and Tails}{Searches for New Physics}
	\begin{multicols}{2}
		...
		\begin{center}
			\includegraphics[width=.75\linewidth]{../Images/simpleopt-06.png}
		\end{center}
		\pause 
...
\begin{frame}{Combined Sensitivity Reach}{The Sensitivity Reach / only right-handed currents}
	\begin{center}
		\includegraphics[width=.68\linewidth]{../Images/Significance_CMS_Comparison_13TeV_L137_all_combined_woRHC.pdf}
	\end{center}
	{\large
...
\begin{frame}{Combined Sensitivity Reach}{Comparison between different Branching ratios}
	\begin{center}
		\includegraphics[width=.68\linewidth]{../Images/Significance_Curves_Summary_by_BR.pdf}
	\end{center}
\end{frame}

\begin{frame}{Including the $Z'$ boson contribution}{The Sensitivity Reach / only left-handed currents}
	\begin{center}
		\includegraphics[width=.68\linewidth]{../Images/zp_lower_limit_woRHC_gu1_75.pdf}
	\end{center}
	{\large
...
\begin{frame}{Including the $Z'$ boson contribution}{The Sensitivity Reach / only left-handed currents}
	\begin{center}
		\includegraphics[width=.68\linewidth]{../Images/zp_upper_limit_woRHC_gu1_75.pdf}
	\end{center}
	{\large
...
\begin{frame}{Including the $Z'$ boson contribution}{The Sensitivity Reach / only left-handed currents}
	\begin{center}
		\includegraphics[width=.45\linewidth]{../Images/zp_lower_limit.pdf}
		\includegraphics[width=.53\linewidth]{../Images/zp_upper_limit.pdf}
	\end{center}
\end{frame}
