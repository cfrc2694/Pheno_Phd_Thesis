...
\begin{frame}{Sensitivity Reach for only Right-Handed Current coupling}
    ...
    \begin{block}{Key Results for $BR(LQ \to b\tau) = 1$, $\quad g_u\beta_R = \sqrt{2} \lambda$}
        \begin{itemize}
            ...
            \item \textcolor{EfficiencyRed}{Note: In contrast to the claims made by CMS, a pure $b\tau$ decay channel cannot arise from left-handed current couplings and then cannot explain the $B$-anomalies.}
        \end{itemize}
    \end{block}
\end{frame}
