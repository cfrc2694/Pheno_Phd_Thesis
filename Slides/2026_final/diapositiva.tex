...
\begin{frame}{Standard Model of Particle Physics}
	\begin{center}
		\includegraphics[width=.95\textwidth]{../Images/SM.png}
	\end{center}
\end{frame}
...
\begin{frame}{Deficiencies of the SM}
    \begin{minipage}[t]{0.43\linewidth}
        \textbf{The SM cannot be complete:}
        \begin{itemize}
            \item Neutrino masses require extension
    ...
    \begin{minipage}[t]{0.53\linewidth}
        ...
        \vspace{0.5em}
        \makebox[\linewidth][l]{\hspace*{-0.6cm}\includegraphics[width=1.2\linewidth]{../Images/rdrds_ckm2025_new.pdf}}
...
\begin{frame}{The Large Hadron Collider (LHC)}
    \begin{minipage}{.6\linewidth}
        \includegraphics[width=1\textwidth]{../Images/LHC.png}
    \end{minipage}
    \hfill
    \begin{minipage}{.38\linewidth}
        \textbf{World's largest particle collider:}
        \begin{itemize}
            \item 27 km circumference ring
            \item Proton-proton collisions at $\sqrt{s} = 13.6$ TeV
            \item Designed to probe the TeV scale
            \item Main experiments: ATLAS, CMS, LHCb, ALICE
            \item Already discovered the Higgs boson (2012)
...
\begin{frame}{Optimizing Sensitivity}
    ...
    \begin{itemize}
        ...
        \item \textcolor{SignalOrange}{Increase $\sigma_s$ via higher $\sqrt{s}$}
