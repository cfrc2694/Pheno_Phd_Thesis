...
\begin{frame}{Summary and Conclusions}
    \begin{itemize}
        ...
        \item Advanced simulation tools combined with Machine Learning techniques are essential for discovery.
    \end{itemize}
	\pause\vfill
    \begin{itemize}
        \item \textbf{$U(1)_{T^3_R}$ Model:} Explains mass hierarchies and offers a dark matter candidate. HL-LHC analyses can probe low-mass regions of its new scalar.
        \item \textbf{Vector Leptoquark ($U_1$) Model:} Explains flavor anomalies. Multivariate analysis extends discovery reach up to $\sim5$ TeV.
    \end{itemize}
	\pause\vfill
    \begin{itemize}
        \item A combined theoretical, simulation, and data analysis effort is crucial for discovering new physics at the HL-LHC.
    \end{itemize}
\end{frame}
