...
\begin{frame}{Standard Model of Particle Physics}
	\begin{center}
		\includegraphics[width=.98\textwidth]{../Images/SM.png}
	\end{center}
\end{frame}
...
\begin{frame}{The Quark-Gluon Sea}
	\begin{center}
		\includegraphics[width=1\textwidth]{../Images/pp_collision.pdf}
	\end{center}
\end{frame}
...
\begin{frame}{Example of a Event in the CMS Detector}
    ...
    $$
    \begin{center}
        \includegraphics[width=1\linewidth]{../Images/real_event.png}
    \end{center}
\end{frame}
