...
\begin{frame}{The Standard Model Higgs Mechanism}
        \begin{center}
            \includegraphics[width=.75\linewidth]{../Images/SM}
        \end{center}
        \begin{itemize}
...
\begin{frame}{Initial State of the Scan ($\tan\beta=10$ fixed)}
  \begin{center}
    \includegraphics[width=\textwidth]{../Images/Initial_THDM_param_scan_analysis}
  \end{center}
\end{frame}
...
\begin{frame}{$\lambda_1 > 0, \quad \lambda_2 > 0$ constraints}
  \begin{center}
    \includegraphics[width=\textwidth]{../Images/stability_lam1_2_condition_THDM_param_scan_analysis}
  \end{center}
\end{frame}
...
\begin{frame}{$\sqrt{\lambda_1\lambda_2} + \lambda_3 + \lambda_4 > \text{máx}(\lambda_4, \abs{\lambda_5})$}
  \begin{center}
    \includegraphics[width=\textwidth]{../Images/stability_lam3_4_condition_THDM_param_scan_analysis}
  \end{center}
\end{frame}

\begin{frame}{Bounded from Below Conditions}
    \includegraphics[width=\textwidth]{../Images/stability_lam1_2_3_4_condition_THDM_param_scan_analysis}
\end{frame}
...
\begin{frame}{Vacuum Stability Conditions}
  \begin{center}
    \includegraphics[width=\textwidth]{../Images/vacuum_stable_THDM_param_scan_analysis}
  \end{center}
...
\begin{frame}{Example: $\abs{f_+}=\abs{\lambda_3 + \lambda_4}\approx \left| m_h^2 + m_A^2 - m_{H}^2 \right|/v^2  < 8\pi$}
  \begin{center}
    \includegraphics[width=\textwidth]{../Images/unitarity_f_plus_THDM_param_scan_analysis}
  \end{center}
...
\begin{frame}{All Unitarity Constraints}
    \begin{center}
        \includegraphics[width=\textwidth]{../Images/unitarity_satisfied_THDM_param_scan_analysis}
    \end{center}
\end{frame}

\begin{frame}{All the theoretical constraints}
    \begin{center}
        \includegraphics[width=\textwidth]{../Images/Theoretical_constraints_satisfied_THDM_param_scan_analysis}
    \end{center}
\end{frame}
...
\begin{frame}{Oblique Parameters Constraints}
  \begin{center}
    \includegraphics[width=\textwidth]{../Images/stu_THDM_param_scan_analysis}
  \end{center}
\end{frame}
...
\begin{frame}{Yukawa Sector (\arxiv 1106.0034)}
    ...
    \begin{center}
        \includegraphics[width=0.75\textwidth]{../Images/Table_Z2_charges.png}
    \end{center}
...
\begin{frame}{Yukawa sector After EWSB}
    ...
    \begin{center}
        \includegraphics[width=0.75\textwidth]{../Images/Table_kappa.png}
    \end{center}
...
\begin{frame}{$H^\pm$ Constraints (\arxiv 2412.04572)}
    ...
    \begin{center}
        \includegraphics[width=0.92\textwidth]{../Images/Hpm_Constrains_by_Model.png}
    \end{center}
\end{frame}
...
\begin{frame}{$H$ Constraints For Type II THDM (\arxiv 2010.03730)}
    ...
    \begin{minipage}{0.48\textwidth}
        \includegraphics[width=\textwidth]{../Images/HH_Constraints.png}
    \end{minipage}\hfill
\begin{minipage}{0.48\textwidth}
    \begin{itemize}
