...
\end{equation}
Computing the second derivatives at the minimum, we find:
\begin{align}
    \left.\frac{\partial^2 V}{\partial \rho_0^2}\right|_{\text{min}} &= 2\lambda_H v_h^2, \\
    \left.\frac{\partial^2 V}{\partial \rho_\phi^2}\right|_{\text{min}} &= 2\lambda_\phi v_\phi^2, \\
    \left.\frac{\partial^2 V}{\partial \rho_0 \partial \rho_\phi}\right|_{\text{min}} &= 2\lambda v_h v_\phi.
\end{align}
Thus, the mass-squared matrix in the $(\rho_0, \rho_\phi)$ basis is:
\begin{equation}
    \mathcal{M}^2 = \begin{pmatrix}
        \lambda_H v_h^2 & \lambda v_h v_\phi \\
        \lambda v_h v_\phi & \lambda_\phi v_\phi^2
    \end{pmatrix},
\end{equation}
where the diagonal elements $\mathcal{M}^2_{11} = \lambda_H v_h^2$ and $\mathcal{M}^2_{22} = \lambda_\phi v_\phi^2$ represent the squared masses of $\rho_0$ and $\rho_\phi$ in the absence of mixing, while the off-diagonal element $\mathcal{M}^2_{12} = \mathcal{M}^2_{21} = \lambda v_h v_\phi$ quantifies the mixing between the two scalar fields induced by the portal coupling $\lambda$.
