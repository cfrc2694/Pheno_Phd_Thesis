...
\begin{description}
  ...
  \item[Neutrino masses] Precision oscillation data continue to require non-zero neutrino masses and mixing. Global fits still prefer normal ordering, but the mass ordering and the Dirac CP phase remain unestablished; see the latest NuFIT summary~\cite{NuFIT2024}. Direct kinematic limits from KATRIN have pushed the effective electron-neutrino mass into the sub-eV regime (about $0.5$ eV at 90\% CL)~\parencite{KATRIN2022,KATRIN2024}.
