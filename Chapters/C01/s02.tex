...
\end{aligned}
\end{equation}
where $f^{a b c}$ and $\epsilon^{i j k}$ are the structure constants of $SU(3)$ and $SU(2)$. Under gauge transformations, the gauge fields $G_\mu$, $W_\mu$, and $B_\mu$ transform as:
\begin{equation}
	\begin{aligned}
