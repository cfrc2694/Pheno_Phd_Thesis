    ...
    \begin{subfigure}[b]{0.48\textwidth}
        ...
        \begin{fmffile}{feyngraph5} 
            ...
            \begin{fmfgraph*}(80,60)
				...
				\fmfv{lab=$ie\gamma^\mu$, lab.dist=0.25cm, lab.angle=115}{v1}
            \end{fmfgraph*}
			\vspace{0.5cm}
        \end{fmffile}
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        ...
        \begin{fmffile}{feyngraph6}
            ...
            \begin{fmfgraph*}(80,60)
				...
				\fmfv{lab=$\frac{ig}{\sqrt{2}}\gamma^\mu P_L$, lab.dist=0.3cm, lab.angle=115}{v1}
            \end{fmfgraph*}
			\vspace{0.5cm}
        \end{fmffile}
	...
	\begin{subfigure}[b]{0.48\textwidth}
		...
		\begin{fmffile}{feyngraph7}
			...
			\begin{fmfgraph*}(80,60)
				...
				\fmfv{lab=$\frac{ig}{\cos\theta_w}\gamma^\mu(g_V - g_A\gamma_5)$, lab.dist=0.4cm, lab.angle=115}{v1}
			\end{fmfgraph*}
			\vspace{0.5cm}
		\end{fmffile}
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        ...
        \begin{fmffile}{feyngraph9} 
            ...
            \begin{fmfgraph*}(80,60)
				...
				\fmfv{lab=$iy_u$, lab.dist=0.25cm, lab.angle=-65}{v1}
            \end{fmfgraph*}
			\vspace{0.5cm}
        \end{fmffile}
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        ...
        \begin{fmffile}{feyngraph10}
            ...
            \begin{fmfgraph*}(80,60)
				...
				\fmfv{lab=$iy_d$, lab.dist=0.25cm, lab.angle=-65}{v1}
            \end{fmfgraph*}
			\vspace{0.5cm}
        \end{fmffile}
	...
	\begin{subfigure}[b]{0.48\textwidth}
		...
		\begin{fmffile}{feyngraph11}
			...
			\begin{fmfgraph*}(80,60)
				...
				\fmfv{lab=$iy_\ell$, lab.dist=0.25cm, lab.angle=-65}{v1}
			\end{fmfgraph*}
			\vspace{0.5cm}
		\end{fmffile}
	...
	\begin{subfigure}[b]{0.48\textwidth}
		...
		\begin{fmffile}{feyngraph12}
			...
			\begin{fmfgraph*}(80,60)
				...
				\fmfv{lab=$g_s f^{abc}$, lab.dist=0.3cm, lab.angle=0}{v1}
			\end{fmfgraph*}
			\vspace{0.5cm}
		\end{fmffile}
