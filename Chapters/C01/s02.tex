...
This gauge structure organizes the fermionic content into doublets and singlets under $SU(2)_L$, while distinguishing between colored and colorless particles:
...
\begin{center}
    \begin{tabular}{|l||c|c|c||c|}
        \hline \textbf{Field} & $SU(3)_C$ & $SU(2)_{L}$ & $U(1)_{Y}$ & $U(1)_{EM}$ \\
        \hline $q_{L}^{i}=\left(u^{i}, d^{i}\right)_{L}$ & $\mathbf{3}$ & $\mathbf{2}$ & $+1/3$ & $(2/3,-1/3)$ \\
        $u_{R}^{i}$ & $\overline{\mathbf{3}}$ & $\mathbf{1}$ & $+4/3$ & $+2/3$ \\
        $d_{R}^{i}$ & $\overline{\mathbf{3}}$ & $\mathbf{1}$ & $-2/3$ & $-1/3$ \\
        $\ell^{i}_L=\left(\nu^{i}, e^{i}\right)_{L}$ & $\mathbf{1}$ & $\mathbf{2}$ & $-1$  & $(0,-1)$ \\
        $e_{R}^{i}$ & $\mathbf{1}$ & $\mathbf{1}$ & $-2$ & $-1$ \\
        $H=\left(H^{+}, H^{0}\right)$ & $\mathbf{1}$ & $\mathbf{2}$ & $+1$ & $(+1,0)$ \\
        \hline \hline
    \end{tabular}
