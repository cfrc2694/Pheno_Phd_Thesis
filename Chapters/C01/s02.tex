...
\end{equation}
The vacuum expectation value (vev) aligns with the electrically neutral component, $\langle H^{0} \rangle = v/\sqrt{2} \simeq 174 \,\mathrm{GeV}$, generating masses for the weak gauge bosons while preserving $U(1)_{\text{EM}}$. The resulting scalar self-interactions are shown in Fig.~\ref{fig-higgs-self-interactions}.

We adopt the Kibble parametrization of the Higgs doublet in terms of one physical scalar $h$ and three would-be Goldstone bosons $G^{\pm},G^0$:
\begin{equation}
