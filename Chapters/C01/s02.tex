    ...
    \begin{subfigure}[b]{0.48\textwidth}
        ...
        \begin{fmffile}{feyngraph14} 
            ...
            \begin{fmfgraph*}(80,60)
                ...
                \fmfv{lab=$igv$, lab.dist=0.3cm, lab.angle=-90}{v1}
            \end{fmfgraph*}
            \vspace{0.5cm}
        \end{fmffile}
        \caption{$hhWW$ coupling.}
        \label{fig-higgs-w}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.48\textwidth}
        ...
        \begin{fmffile}{feyngraph15}
            ...
            \begin{fmfgraph*}(80,60)
                ...
                \fmfv{lab=$\frac{igv}{\cos\theta_w}$, lab.dist=0.3cm, lab.angle=-65}{v1}
            \end{fmfgraph*}
            \vspace{0.5cm}
        \end{fmffile}
        \caption{$hhZ$ coupling.}
        \label{fig-higgs-z}
    \end{subfigure}
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \begin{fmffile}{feyngraph18}
            ...
            \begin{fmfgraph*}(80,60)
                ...
                \fmfv{lab=$igm_W$, lab.dist=0.3cm, lab.angle=-90}{v1}
            \end{fmfgraph*}
            \vspace{0.5cm}
        \end{fmffile}
        \caption{$hWW$ coupling.}
        \label{fig-higgs-w-triple}
    \end{subfigure}
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \begin{fmffile}{feyngraph19}
            ...
            \begin{fmfgraph*}(80,60)
                ...
                \fmfv{lab=$igm_Z/\cos\theta_w$, lab.dist=0.3cm, lab.angle=-65}{v1}
            \end{fmfgraph*}
            \vspace{0.5cm}
        \end{fmffile}
        \caption{$hZ$ coupling.}
        \label{fig-higgs-z-triple}
    \end{subfigure}
    \caption{Feynman diagrams for Higgs-gauge boson interactions arising from the covariant derivative term $\mathcal{D}_\mu H^\dagger \mathcal{D}^\mu H$ in the Higgs Lagrangian.}
