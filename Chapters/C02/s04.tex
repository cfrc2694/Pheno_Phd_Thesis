...
Despite this limitation, the $\kappa$ metric remains invaluable for establishing \textit{experimental sensitivity}—defined as the minimum signal strength required to achieve a certain significance level (e.g., 95\% CL exclusion or $5\sigma$ discovery potential). It provides a powerful tool for:
\begin{itemize}
    \item Quick optimization of analysis strategies and binning schemes
    \item Estimating the integrated luminosity required to probe certain signal models
    \item Comparing the relative sensitivity of different search channels or analysis variables
    \item Designing trigger strategies and allocating computing resources
\end{itemize}
