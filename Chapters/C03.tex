...
\begin{center}
    ...
    \captionof{figure}{Signal cross-section as a function of the $\textrm{vLQ}$ mass, for $\sqrt{ s}=13 \tev$, with $g_U=1.0$. We show single, pair, and non-resonant production, for $\beta_R^{b\tau}=-1,\,0$ in solid and dashed lines, respectively.%%
