...
\begin{center}
    ...
    \captionof{figure}{Cross section for scalar leptoquark (sLQ) pair production decaying to $\tau^+\tau^-$ final states, showing different $\tau$ polarization configurations as a function of sLQ mass at $\sqrt{s}=13$ TeV. The coupling is fixed to  $\tilde{y}_{33} = 1.0$.}\label{fig:cross_section_sLQ}
\end{center}
...
\begin{center}
    ...
    \captionof{figure}{Cross section for vector-like quark (vLQ) pair production decaying to $\tau^+\tau^-$ final states, showing different $\tau$ polarization configurations as a function of vLQ mass at $\sqrt{s}=13$ TeV. The couplings are fixed to $g_U = 1.0$ and $\beta_R^{b\tau} = -0.85$.}\label{fig:cross_section}
\end{center}
