...
The scalar leptoquark $\tilde{S}_1 = (\overline{\mathbf{3}}, \mathbf{1}, 4/3)$ emerges as an attractive beyond-Standard Model (BSM) candidate that could explain observed anomalies in $\tau$-lepton final states. This section details its theoretical framework and phenomenological implications.
...
\begin{align}
    q\bar{q} &\to \tilde{S}_1\tilde{S}_1^* \to \tau^+\tau^- + X \\
    gg &\to \tilde{S}_1\tilde{S}_1^* \to (b\tau^+)(\bar{b}\tau^-)
\end{align}
